...
if __name__ == '__main__':
        ...
        f1.write('Accuracy for K Nearest Neighbor Single Class Classification' + '\n')
        f1.write('The training accuracy is : '+ str(knn.score(Y,y_train))+'\n')
        f1.write('The training accuracy is : '+ str(knn.score(Y_test,y_test))+'\n\n')
