...
if __name__ == '__main__':
        ...
        print(lda.score(Y_test,y_test))
        
        f1 = open('Results.txt','a')
        f1.write('Accuracy for Linear Discrminant Analysis Double Class Classification' + '\n')
        f1.write('The training accuracy is : '+ str(lda.score(Y,y_train))+'\n')
        f1.write('The training accuracy is : '+ str(lda.score(Y_test,y_test))+'\n\n')
